...
<body class="login-bg">
	...
	<div class="main">
		<div class="login-dom">
			...
			<div class=" text-center margin-small-top logo-color text-small">控制台
				| 云平台 | 论坛 | 云市场</div>
			<form class="register-form" name="register"
				action="http://account.haidao.la/index.php?c=Index&a=register"
				method="post" autocomplete="off">
				<div class="reg-wrap border">
					<div class="reg-number border-bottom">
						<div class="fl reg-area text-gray">+86</div>
						<input type="text" class="fl reg-phone" name="mobile" id="mobile"
							placeholder="请输入手机号码" datatype="m"
							ajaxurl="http://account.haidao.la/index.php?c=Index&a=check_mobile" />
					</div>
					<div class="reg-number">
						<input type="text" disabled="disabled" name="vcode" id="vcode"
							class="fl padding-big-left reg-code" placeholder="请输入验证码" /> <a
							href="#" class="fl reg-send" id="send">发送验证码</a>
					</div>
				</div>
			...
			<div class="forget">
				...
				<a href="login.html" class="forget-new text-small fr"
					id="forger-login">已有账号，立即登录</a>
			</div>
		</div>
